...
void kedua()        //Subrogram untuk menampilkan Pembelian Tiket
{
    ...
    menu:
        ...
        {
            cout<<"\n\t\t    Penumpang Ke-"<<i<<endl;
            cout<<"\t\t    Nama \t : ";cin>>tiket[i].nama;
            fflush(stdin);
            cout<<"\t\t    No. KTP/NIK\t : ";cin>>tiket[i].ktp;
        }
    ...
    gotoxy(20,7);cout<<"Jumlah Tiket Yang di Pesan : "<<jum<<" Tiket";
    {
        if (kls==1)
        {
            ...
            gotoxy(20,9);cout<<"Harga Satuan Tiket         : Rp35000";
        }
        else if (kls==2)
        {
            gotoxy(20,8);cout<<"Kelas Yang Dipilih         : Bisnis";
            gotoxy(20,9);cout<<"Harga Satuan Tiket         : Rp25000";
        }
        else if (kls==3)
        {
            gotoxy(20,8);cout<<"Kelas Yang Dipilih         : Ekonomi";
            gotoxy(20,9);cout<<"Harga Satuan Tiket         : Rp10000";
        }
    }
    gotoxy(20,11);cout<<"=========================================================";
    {
    ...
    print :         // Menyimpan Detail Tiket Kereta Ke file "Print Tiket.txt"
    ofstream simpan_tiket;
    simpan_tiket.open("Print Tiket.txt", ios :: app);
    simpan_tiket<<"\n\t\t    =========================================================";
    simpan_tiket<<"\n\t\t                                                            TIKET KERETA YANG ANDA PESAN";
    simpan_tiket<<"\n\t\t    =========================================================";
    for (int a=1;a<=jum;a++)
        {simpan_tiket<<"\n\t\t    Nama\t\t : "<<tiket[a].nama;simpan_tiket<<"\tNo KTP\t\t : "<<tiket[a].ktp;}
...
switch(jur)
    ...
    rekap:          //Menampilkan Detail Tiket Kereta yang di Pesan
    header();
    gotoxy(20,7);cout<<"=========================================================";
    ...
    for (int a=1;a<=jum;a++)
        {
            cout<<"\n\t\t    Nama\t : "<<tiket[a].nama;cout<<"\tNo KTP\t : "<<tiket[a].ktp;
        }
